  ...
  "grow font-medium inline-flex items-center justify-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        alert: "data-[state=active]:bg-red-500/10 data-[state=active]:bg-gradient-to-br data-[state=active]:from-red-500/10 data-[state=active]:to-red-500/60 data-[state=active]:text-red-700",
        success: "data-[state=active]:bg-emerald-500/10 data-[state=active]:bg-gradient-to-br data-[state=active]:from-emerald-500/10 data-[state=active]:to-emerald-500/60 data-[state=active]:text-emerald-700",
        nearSuccess: "data-[state=active]:bg-violet-500/10 data-[state=active]:bg-gradient-to-br data-[state=active]:from-violet-500/10 data-[state=active]:to-violet-500/60 data-[state=active]:text-violet-700",
...
const TabsTrigger = React.forwardRef<
  ...
  TabsTriggerProps & React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger>
