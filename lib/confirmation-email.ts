...
export interface SendEmailProps extends EmailTemplateProps {
  email: string;
}
...
<![endif]-->
  ...
  <![endif]-->
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="dc79cfcf-d93d-4463-ac3f-ac1a99d9c325">
      <tbody>
        <tr>
          <td align="center" bgcolor="" class="outer-td" style="padding:18px 0px 18px 0px;">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                <tr>
                <td align="center" bgcolor="#fc7442" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a href="https://hawaiiansintech-git-tho-join-page-hawaiians.vercel.app/join/status?r=${airtableID}" style="background-color:#fc7442; border:1px solid #fc7442; border-color:#fc7442; border-radius:6px; border-width:1px; color:#ffffff; display:inline-block; font-size:16px; font-weight:700; letter-spacing:0px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid;" target="_blank">Review Status</a>
                </td>
                </tr>
              </tbody>
            </table>
    ...
    </table><table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="9ce5d274-c78b-4fdd-a292-d915211a9a33">
    <tbody>
      <tr>
...
export async function sendEmail({ email, airtableID, name }: SendEmailProps) {
  SendGrid.send({
    to: email,
    from: {
